...
from torch import randint, all, eq, Tensor, where,all,eq
...
"""
eos_first_token = 1
out = randint(0, 2, (1, 10, 3))
print(out)
# check if first value of each row is eos_first_token, other values don't matter
